...
## 1.项目简介
这个开源示例项目演示了如何快速集成 网易云信 新一代（G2）音视频 SDK，实现AI降噪功能。
...
[在线体验](https://app.yunxin.163.com/webdemo/g2web/index.html#/?path=denoise)
...
运行后通过 https://localhost:8020/index.html#/?path=denoise 进行访问
...
- 当前功能内部署了云信的4.6.25版本的sdk，如需要最新版本的sdk请主动去[云信官网](https://yunxin.163.com/)下载
